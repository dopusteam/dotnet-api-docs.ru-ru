### <a name="two-way-data-binding-to-a-property-with-a-non-public-setter-is-not-supported"></a>Двухстороннюю привязку данных к свойству с помощью неоткрытые setter не поддерживается.
