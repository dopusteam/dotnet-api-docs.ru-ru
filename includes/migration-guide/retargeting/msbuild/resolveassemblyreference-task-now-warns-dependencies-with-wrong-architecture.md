### <a name="resolveassemblyreference-task-now-warns-of-dependencies-with-the-wrong-architecture"></a>Задача ResolveAssemblyReference теперь выдает предупреждение, зависимостей с неправильную архитектуру
